    ...
    public boolean login() {
        try {
            ...
            *///?}
            ...
            accessor.nofingerprint$setUserApiService(UserApiService.OFFLINE);
            ...
            this.lastError = null;
            NoFingerprint.LOGGER.info("[NoFingerprint] Successfully logged in as offline account: {}", username);
            return true;

        } catch (Exception e) {
            this.lastError = "Login error: " + e.getMessage();
            NoFingerprint.LOGGER.error("[NoFingerprint] Failed to login as offline account: {}", e.getMessage(), e);
            return false;
        }
    }
