...
import io.github.dimaniojk.nofingerprint.accounts.AccountManager;
import io.github.dimaniojk.nofingerprint.accounts.Account;
import io.github.dimaniojk.nofingerprint.accounts.SessionAccount;
...
import io.github.dimaniojk.nofingerprint.mixin.MeteorMixinCanceller;
import io.github.dimaniojk.nofingerprint.protection.ResourcePackGuard;
...
public class NoFingerprintConfigScreen extends Screen {
    ...
    private final NoFingerprintConfig config;
    ...
    *///?}
    ...
    public NoFingerprintConfigScreen(Screen parent) {
        this(parent, 0, 0);
    }

    public NoFingerprintConfigScreen(Screen parent, int initialTab) {
        this(parent, initialTab, 0);
    }

    public NoFingerprintConfigScreen(Screen parent, int initialTab, double scrollOffset) {
        super(NoFingerprintLang.component(NoFingerprintStrings.CONFIG_TITLE));
        this.parent = parent;
        this.config = NoFingerprintConfig.getInstance();
    ...
    protected void init() {
        ...
        this.resetButton = Button.builder(Component.translatable("controls.reset"), button -> {
          ...
          .tooltip(Tooltip.create(NoFingerprintLang.component(isAccountsTab
                  ? NoFingerprintStrings.BUTTON_RESET_DISABLED_TOOLTIP
                  : NoFingerprintStrings.BUTTON_RESET_TOOLTIP)))
          .build();
        ...
        *///?}
        ...
        if (versionOutdated) {
            this.versionLabel.setTooltip(Tooltip.create(NoFingerprintLang.component(
                    NoFingerprintStrings.VERSION_TOOLTIP_OUTDATED, UpdateChecker.getLatestVersion())));
        } else {
            this.versionLabel.setTooltip(Tooltip.create(NoFingerprintLang.component(NoFingerprintStrings.VERSION_TOOLTIP_UPTODATE)));
        }
    ...
    private Tab createProtectionTab(SpoofSettings settings) {
        ...
        widgets.add(cycleBuilder(COLORED_BOOL_TO_TEXT, List.of(Boolean.TRUE, Boolean.FALSE), settings.isStripModShaders())
            .withTooltip(v -> Tooltip.create(NoFingerprintLang.component(NoFingerprintStrings.TOOLTIP_STRIP_MOD_SHADERS)))
                .create(0, 0, 230, 20, NoFingerprintLang.component(NoFingerprintStrings.OPTION_STRIP_MOD_SHADERS),
                (button, value) -> { settings.setStripModShaders(value); config.save(); }));

        widgets.add(Button.builder(NoFingerprintLang.component(NoFingerprintStrings.OPTION_CLEAR_CACHE), button -> {
                ResourcePackGuard.clearAllCaches();
            }).size(230, 20)
          .tooltip(Tooltip.create(NoFingerprintLang.component(NoFingerprintStrings.TOOLTIP_CLEAR_CACHE)))
          .build());
        ...
        if (NoFingerprintConfig.EXPLOIT_PREVENTER_LOADED) {
            ...
            widgets.add(cycleBuilder(COLORED_BOOL_TO_TEXT, List.of(Boolean.TRUE, Boolean.FALSE), settings.isTranslationProtectionEnabled())
                .withTooltip(v -> Tooltip.create(NoFingerprintLang.component(NoFingerprintStrings.TOOLTIP_KEY_RESOLUTION_SPOOFING)))
                    .create(0, 0, 230, 20, NoFingerprintLang.component(NoFingerprintStrings.OPTION_KEY_RESOLUTION_SPOOFING),
                        (button, value) -> {
        ...
        if (NoFingerprintConfig.CHAT_SIGNING_MANAGED_EXTERNALLY) {
            String manager = NoFingerprintConfig.chatSigningManagerName();
            widgets.add(createSectionHeader(NoFingerprintLang.tr(NoFingerprintStrings.COMPAT_MANAGED_HEADER, manager)));
            lastManagedHeader = manager;
            widgets.add(createManagedToggle(NoFingerprintLang.component(NoFingerprintStrings.OPTION_CHAT_SIGNING),
                    NoFingerprintLang.component(NoFingerprintStrings.COMPAT_MANAGED_TOOLTIP, manager)));
        } else {
            widgets.add(cycleBuilder(SigningModeDisplay::getDisplayName, List.of(SpoofSettings.SigningMode.values()), settings.getSigningMode())
                    ...
                    .create(0, 0, 230, 20, NoFingerprintLang.component(NoFingerprintStrings.OPTION_CHAT_SIGNING),
        ...
        if (NoFingerprintConfig.TELEMETRY_MANAGED_EXTERNALLY) {
            String manager = NoFingerprintConfig.telemetryManagerName();
            // Reuse the header above when the control directly preceding shares this manager.
            if (!manager.equals(lastManagedHeader)) {
                widgets.add(createSectionHeader(NoFingerprintLang.tr(NoFingerprintStrings.COMPAT_MANAGED_HEADER, manager)));
            }
            widgets.add(createManagedToggle(NoFingerprintLang.component(NoFingerprintStrings.OPTION_DISABLE_TELEMETRY),
                    NoFingerprintLang.component(NoFingerprintStrings.COMPAT_MANAGED_TOOLTIP, manager)));
        } else {
            widgets.add(cycleBuilder(COLORED_BOOL_TO_TEXT, List.of(Boolean.TRUE, Boolean.FALSE), settings.isDisableTelemetry())
                    .withTooltip(v -> Tooltip.create(NoFingerprintLang.component(NoFingerprintStrings.TOOLTIP_DISABLE_TELEMETRY)))
                    .create(0, 0, 230, 20, NoFingerprintLang.component(NoFingerprintStrings.OPTION_DISABLE_TELEMETRY),
                    (button, value) -> { settings.setDisableTelemetry(value); config.save(); }));
        }

        return new WidgetTab(NoFingerprintLang.component(NoFingerprintStrings.TAB_PROTECTION), widgets);
    }
    ...
    private Tab createMiscTab(SpoofSettings settings) {
        ...
        widgets.add(createSectionHeader(NoFingerprintLang.tr(NoFingerprintStrings.SECTION_ALERTS)));
        
        widgets.add(cycleBuilder(COLORED_BOOL_TO_TEXT, List.of(Boolean.TRUE, Boolean.FALSE), settings.isShowAlerts())
                .withTooltip(v -> Tooltip.create(NoFingerprintLang.component(NoFingerprintStrings.TOOLTIP_SHOW_ALERTS)))
                .create(0, 0, 230, 20, NoFingerprintLang.component(NoFingerprintStrings.OPTION_SHOW_ALERTS),
        ...
        widgets.add(cycleBuilder(COLORED_BOOL_TO_TEXT, List.of(Boolean.TRUE, Boolean.FALSE), settings.isShowToasts())
                .withTooltip(v -> Tooltip.create(NoFingerprintLang.component(NoFingerprintStrings.TOOLTIP_SHOW_TOASTS)))
                .create(0, 0, 230, 20, NoFingerprintLang.component(NoFingerprintStrings.OPTION_SHOW_TOASTS),
        ...
        widgets.add(cycleBuilder(COLORED_BOOL_TO_TEXT, List.of(Boolean.TRUE, Boolean.FALSE), settings.isLogDetections())
                .withTooltip(v -> Tooltip.create(NoFingerprintLang.component(NoFingerprintStrings.TOOLTIP_LOG_DETECTIONS)))
                .create(0, 0, 230, 20, NoFingerprintLang.component(NoFingerprintStrings.OPTION_LOG_DETECTIONS),
                (button, value) -> { settings.setLogDetections(value); config.save(); }));

        // Debug Section
        widgets.add(createSectionHeader(NoFingerprintLang.tr(NoFingerprintStrings.SECTION_DEBUG)));

        widgets.add(cycleBuilder(COLORED_BOOL_TO_TEXT, List.of(Boolean.TRUE, Boolean.FALSE), settings.isDebugAlerts())
                .withTooltip(v -> Tooltip.create(NoFingerprintLang.component(NoFingerprintStrings.TOOLTIP_DEBUG_ALERTS)))
                .create(0, 0, 230, 20, NoFingerprintLang.component(NoFingerprintStrings.OPTION_DEBUG_ALERTS),
        ...
        widgets.add(cycleBuilder(COLORED_BOOL_TO_TEXT, List.of(Boolean.TRUE, Boolean.FALSE), settings.isDebugCommand())
                .withTooltip(v -> Tooltip.create(NoFingerprintLang.component(NoFingerprintStrings.TOOLTIP_DEBUG_COMMAND)))
                .create(0, 0, 230, 20, NoFingerprintLang.component(NoFingerprintStrings.OPTION_DEBUG_COMMAND),
                (button, value) -> { settings.setDebugCommand(value); config.save(); }));

        return new WidgetTab(NoFingerprintLang.component(NoFingerprintStrings.TAB_MISC), widgets);
    }
    ...
    private Tab createAccountsTab() {
        ...
        widgets.add(createSectionHeader(NoFingerprintLang.tr(NoFingerprintStrings.ACCOUNT_CURRENT, currentUser)));
        
        // List saved accounts
        if (!accountManager.getAccounts().isEmpty()) {
            widgets.add(createSectionHeader(NoFingerprintLang.tr(NoFingerprintStrings.SECTION_SAVED_ACCOUNTS)));
                ...
                widgets.add(new AccountRowWidget(
                        ...
                        () -> {
                            ...
                            if (isLoggedIn) {
                                ...
                                isLoggingOut = true;
                                NoFingerprint.LOGGER.info("[NoFingerprint] Logging out of account: {}", account.getUsername());
                                ...
                                NoFingerprint.LOGGER.info("[NoFingerprint] Logging into account: {}", account.getUsername());
            ...
            Button refreshButton = Button.builder(NoFingerprintLang.component(
                    accountManager.isRefreshing() ? NoFingerprintStrings.BUTTON_REFRESHING : NoFingerprintStrings.BUTTON_REFRESH_ALL
            ), button -> {
                if (accountManager.isRefreshing()) {
                    return; // Already refreshing
                }
                button.setMessage(NoFingerprintLang.component(NoFingerprintStrings.BUTTON_REFRESHING));
                button.active = false;
                accountManager.refreshAllAccounts((valid, invalid) -> {
                    refreshScreen();
                });
            }).size(230, 20)              .tooltip(Tooltip.create(NoFingerprintLang.component(NoFingerprintStrings.BUTTON_REFRESH_TOOLTIP)))
        ...
        // Add account section
        widgets.add(createSectionHeader(NoFingerprintLang.tr(NoFingerprintStrings.SECTION_ADD_ACCOUNT)));
        
        // Add button to open add account dialog
        widgets.add(Button.builder(NoFingerprintLang.component(NoFingerprintStrings.ACCOUNT_ADD_SESSION), button -> {
            //? if >=26.2 {
          ...
          .tooltip(Tooltip.create(NoFingerprintLang.component(NoFingerprintStrings.ACCOUNT_ADD_SESSION_TOOLTIP)))
          .build());

        widgets.add(Button.builder(NoFingerprintLang.component(NoFingerprintStrings.ACCOUNT_ADD_OFFLINE), button -> {
            //? if >=26.2 {
          ...
          .tooltip(Tooltip.create(NoFingerprintLang.component(NoFingerprintStrings.ACCOUNT_ADD_OFFLINE_TOOLTIP)))
          .build());
        ...
        return new WidgetTab(NoFingerprintLang.component(NoFingerprintStrings.TAB_ACCOUNTS), widgets);
    }
    ...
    private void openImportDialog() {
        new Thread(() -> {
            try (MemoryStack stack = MemoryStack.stackPush()) {
                ...
                Minecraft.getInstance().execute(() -> {
                    if (imported > 0) {
                        NoFingerprint.LOGGER.info("[NoFingerprint] Imported {} accounts from {}", imported, file.getName());
                    }
                    refreshScreen();
                });
            } catch (Exception e) {
                NoFingerprint.LOGGER.error("[NoFingerprint] Failed to import accounts: {}", e.getMessage());
            }
        }, "NoFingerprint-Import-Thread").start();
    }
        ...
        new Thread(() -> {
            try (MemoryStack stack = MemoryStack.stackPush()) {
                ...
                String result = TinyFileDialogs.tinyfd_saveFileDialog(
                    "Export Accounts",
                    "nofingerprint-accounts-export.json",
                    filters,
                    "JSON Files (*.json)"
                );
                ...
                NoFingerprint.LOGGER.info("[NoFingerprint] Exported accounts to {}", file.getPath());
            } catch (Exception e) {
                NoFingerprint.LOGGER.error("[NoFingerprint] Failed to export accounts: {}", e.getMessage());
            }
        }, "NoFingerprint-Export-Thread").start();
    }
    ...
    private static class AccountRowWidget extends AbstractWidget {
        ...
        public AccountRowWidget(String accountName, String tooltip, boolean isActive, Runnable onAccountClick, Runnable onRemoveClick) {
            ...
            this.removeButton = Button.builder(NoFingerprintLang.component(NoFingerprintStrings.BUTTON_REMOVE), btn -> onRemoveClick.run())
                    .size(55, 20)
                    .tooltip(Tooltip.create(NoFingerprintLang.component(NoFingerprintStrings.BUTTON_REMOVE_TOOLTIP)))
                    .build();
        }
    ...
    private static class ImportExportRowWidget extends AbstractWidget {
        ...
        public ImportExportRowWidget(Runnable onImport, Runnable onExport) {
            ...
            this.importButton = Button.builder(NoFingerprintLang.component(NoFingerprintStrings.BUTTON_IMPORT), btn -> onImport.run())
                    .size(100, 20)
                    .tooltip(Tooltip.create(NoFingerprintLang.component(NoFingerprintStrings.BUTTON_IMPORT_TOOLTIP)))
                    .build();
            
            this.exportButton = Button.builder(NoFingerprintLang.component(NoFingerprintStrings.BUTTON_EXPORT), btn -> onExport.run())
                    .size(100, 20)
                    .tooltip(Tooltip.create(NoFingerprintLang.component(NoFingerprintStrings.BUTTON_EXPORT_TOOLTIP)))
                    .build();
        }
    ...
    private static class ToggleAllRowWidget extends AbstractWidget {
        ...
        public ToggleAllRowWidget(Runnable onEnableAll, Runnable onDisableAll) {
            ...
            this.enableAllButton = Button.builder(NoFingerprintLang.component(NoFingerprintStrings.BUTTON_ENABLE_ALL), btn -> onEnableAll.run())
                    .size(100, 20)
                    .tooltip(Tooltip.create(NoFingerprintLang.component(NoFingerprintStrings.BUTTON_ENABLE_ALL_TOOLTIP)))
                    .build();

            this.disableAllButton = Button.builder(NoFingerprintLang.component(NoFingerprintStrings.BUTTON_DISABLE_ALL), btn -> onDisableAll.run())
                    .size(100, 20)
                    .tooltip(Tooltip.create(NoFingerprintLang.component(NoFingerprintStrings.BUTTON_DISABLE_ALL_TOOLTIP)))
                    .build();
        }
    ...
    private Tab createWhitelistTab(SpoofSettings settings) {
        ...
        if (NoFingerprintConfig.EXPLOIT_PREVENTER_LOADED) {
            ...
            CycleButton<SpoofSettings.WhitelistMode> lockedModeButton = cycleBuilder(WhitelistModeDisplay::getDisplayName, List.of(SpoofSettings.WhitelistMode.values()), SpoofSettings.WhitelistMode.OFF)
                    .withTooltip(v -> Tooltip.create(NoFingerprintLang.component(NoFingerprintStrings.OPTION_WHITELIST_MODE_LOCKED_TOOLTIP)))
                    .create(0, 0, 230, 20, NoFingerprintLang.component(NoFingerprintStrings.OPTION_WHITELIST_MODE), (b, v) -> {});
            ...
            widgets.add(cycleBuilder(
                    ...
                    .create(0, 0, 230, 20, NoFingerprintLang.component(NoFingerprintStrings.OPTION_WHITELIST_MODE),
                        (button, value) -> {
            ...
            if (settings.getWhitelistMode() == SpoofSettings.WhitelistMode.AUTO) {
                ...
                for (ModContainer mod : whitelistableMods) {
                    ...
                    if (hasChannels) {
                        widgets.add(createSectionHeader("\u00A7a" + modName + NoFingerprintLang.tr(NoFingerprintStrings.WHITELIST_SUFFIX_CHANNELS, info.getChannels().size())));
                    } else if (ModRegistry.isInDependencyClosure(modId)) {
                        widgets.add(createSectionHeader("\u00A7a" + modName + NoFingerprintLang.tr(NoFingerprintStrings.WHITELIST_SUFFIX_REQUIRED)));
                    }
                }
            } else if (settings.getWhitelistMode() == SpoofSettings.WhitelistMode.CUSTOM) {
                // ON mode: existing manual toggle UI
                widgets.add(createSectionHeader(NoFingerprintLang.tr(NoFingerprintStrings.SECTION_INSTALLED_MODS)));
                ...
                for (ModContainer mod : whitelistableMods) {
                    ...
                    Component tooltip = isImplicit
                        ? NoFingerprintLang.component(NoFingerprintStrings.WHITELIST_TOOLTIP_REQUIRED_BY,
        ...
        return new WidgetTab(NoFingerprintLang.component(NoFingerprintStrings.TAB_WHITELIST), widgets);
    }
    ...
    private void refreshScreen() {
        ...
        //? if >=26.2 {
        /*this.minecraft.setScreenAndShow(new NoFingerprintConfigScreen(this.parent, tabIndex, scroll));*/
        //?} else {
        this.minecraft.setScreen(new NoFingerprintConfigScreen(this.parent, tabIndex, scroll));
        //?}
    }
    ...
    *///?}
    ...
    private void openReleaseUrl() {
        try {
            ...
            NoFingerprint.LOGGER.warn("[NoFingerprint] Failed to open release URL: {}", e.getMessage());
        }
    }
    ...
    *///?}
    ...
    private static class WhitelistModeDisplay {
        public static Component getDisplayName(SpoofSettings.WhitelistMode mode) {
            return switch (mode) {
                case OFF -> NoFingerprintLang.component(NoFingerprintStrings.WHITELIST_MODE_BLOCK_ALL);
                case AUTO -> NoFingerprintLang.component(NoFingerprintStrings.WHITELIST_MODE_AUTO);
                case CUSTOM -> NoFingerprintLang.component(NoFingerprintStrings.WHITELIST_MODE_CUSTOM);
            };
        }

        public static Component getTooltip(SpoofSettings.WhitelistMode mode) {
            return switch (mode) {
                case OFF -> NoFingerprintLang.component(NoFingerprintStrings.WHITELIST_MODE_BLOCK_ALL_TOOLTIP);
                case AUTO -> NoFingerprintLang.component(NoFingerprintStrings.WHITELIST_MODE_AUTO_TOOLTIP);
                case CUSTOM -> NoFingerprintLang.component(NoFingerprintStrings.WHITELIST_MODE_CUSTOM_TOOLTIP);
            };
        }
    }
    ...
    private static class SigningModeDisplay {
        ...
        public static Component getTooltip(SpoofSettings.SigningMode mode) {
            return switch (mode) {
                case SIGN -> NoFingerprintLang.component(NoFingerprintStrings.CHATSIGNING_SIGN_TOOLTIP);
                case OFF  -> NoFingerprintLang.component(NoFingerprintStrings.CHATSIGNING_OFF_TOOLTIP);
            };
        }
    }
}
