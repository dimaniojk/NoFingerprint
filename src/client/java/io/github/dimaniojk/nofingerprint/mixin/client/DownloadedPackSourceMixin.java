...
public abstract class DownloadedPackSourceMixin {
    ...
    private FilePackResources.FileResourcesSupplier nofingerprint$wrapFilePackSupplier(
            Path file,
        ...
        if (!NoFingerprintConfig.getInstance().shouldWrapServerPacks()) return real;
